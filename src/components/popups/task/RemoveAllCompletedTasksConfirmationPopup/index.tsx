...
export const RemoveAllCompletedTasksConfirmationPopup: React.FC<Props> = (props) => {
  ...
  return (
    <ConfirmationPopup
      opened={props.opened}
      title={getLocalizedText(LocalizationDataKey.POPUPS_REMOVE_ALL_COMPLETED_TASKS_CONFIRMATION_POPUP_TITLE)}
